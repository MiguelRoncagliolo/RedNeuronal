...
Uso:
    python augment_data/augment_potencial_cliente.py --n 300 --with_context_ratio 0.3
"""
...
class PotencialClienteGenerator:
    ...
    def generate_dataset(self, n, with_context_ratio=0.3, style='chileno'):
        ...
        while generated_count < n and total_attempts < n * 3:
            total_attempts += 1
            ...
            if text is not None:
                example = {
                    ...
                    "chat_id": f"chat_{generated_count // 10:04d}",
